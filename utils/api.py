...
# credits @ultve
class Api:
    def __init__(this, userAgent: str = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36', cookies: dict = {}): # credits @ultve
    ...
    def x_tt_decrypt(enc: bytes | str, key: bytes = b"webapp1.0+202106") -> str:
        return ( 
            AES.new(key, AES.MODE_CBC, key)
                .decrypt(b64decode(enc)) # credits @ultve
                .strip()
                .decode("utf-8")
        )
# credits @ultve
    ...
    def get_params(this, extra: dict = {}, device_id: int = randint(7000000000000000000, 7999999999999999999)) -> str:
        return urlencode({
            **extra,
            ...
            'channel'           : 'tiktok_web', # credits @ultve
            'cookie_enabled'    : 'true',
            'device_id'         : device_id,
