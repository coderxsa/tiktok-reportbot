...
class TikReport:
    def __init__(this, cookies: dict):
        ...
        this.userInfo  = None
        this.selfInfo  = None
        this.reasons   = ['9101', '91011', '9009', '90093', '90097', '90095', '90064', '90061', '90063', '9006', '9008', '90081', '90082', '9007', '1001', '1002', '1003', '1004', '9002', '90011', '90010', '9001', '9010', '9011', '90112', '90113', '9003', '90031', '90032', '90033', '90034', '90035', '90036', '9004', '9005', '9012', '910121', '910122', '91012', '91013', '910131', '910132', '910133', '910134', '910135', '91014', '9013', '9102'] # credits @ultve
# credits @ultve
...
if __name__ == '__main__':
    ...
    if not cookies.get('sessionid'):
        cookies['sessionid'] = input('sessionid: ') # More for advanced dev to find
